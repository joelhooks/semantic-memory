...
This repo treats dependency, workflow, source, and release changes as security-sensitive.
...
- Require review for `.github/workflows/`, `.github/actions/`, package manifests, lockfiles, `.npmrc`, source, and release config.
